...
export default {
	...
	data() {
		return {
			...
			templates: {
				Lobbies: [
					{ name: 'GRAB Shopping Center', path: 'lobbies/grab-shopping-center.level', },
					{ name: 'Lobby november castle 2025', path: 'lobbies/lobby-november-2025-castle.level', },
					{ name: 'Lobby november 2025', path: 'lobbies/lobby-november-2025.level', },
					{ name: 'Lobby halloween extra 2025', path: 'lobbies/lobby-halloween-2025-extra.level', },
					{ name: 'Lobby halloween 2025', path: 'lobbies/lobby-halloween-2025.level', },
					{ name: 'Lobby movie studio minigames 2025', path: 'lobbies/lobby-movie-studio-minigames-2025.level', },
					{ name: 'Lobby movie studio 2025', path: 'lobbies/lobby-movie-studio-2025.level', },
					{ name: 'Lobby museum atrium 2025', path: 'lobbies/lobby-museum-atrium-2025.level', },
					{ name: 'Lobby museum 2025', path: 'lobbies/lobby-museum-2025.level', },
					{ name: 'Lobby starship minigames 2025', path: 'lobbies/lobby-starship-minigames-2025.level', },
					{ name: 'Lobby starship 2025', path: 'lobbies/lobby-starship-2025.level', },
					{ name: 'Lobby summer volcano 2025', path: 'lobbies/lobby-summer-vulcano-2025.level', },
					{ name: 'Lobby summer 2025', path: 'lobbies/lobby-summer-2025.level', },
					{ name: 'Lobby gondola 2025', path: 'lobbies/lobby-gondola-2025.level', },
					{ name: 'Lobby hub 2025', path: 'lobbies/lobby-hub-2025.level', },
					...
					{ name: 'Lobby steampunk (animated) 2024', path: 'lobbies/lobby-steampunk-animated-2024.level', },
					...
					{ name: 'Lobby christmas (animated) 2023', path: 'lobbies/lobby-christmas-animated-2023.level', },
					...
					{ name: 'Lobby halloween (animated) 2023', path: 'lobbies/lobby-halloween-animated-2023.level', },
					{ name: 'Lobby halloween 2023', path: 'lobbies/lobby-halloween-2023.level', },
					{ name: 'Lobby castle (animated) 2023', path: 'lobbies/lobby-castle-animated-2023.level', },
					{ name: 'Lobby castle 2023', path: 'lobbies/lobby-castle-2023.level', },
					{ name: 'Lobby summer (animated) 2023', path: 'lobbies/lobby-summer-animated-2023.level', },
					...
					{ name: 'Lobby space 2023', path: 'lobbies/lobby-space-2023.level', },
					{ name: 'Lobby easter (animated) 2023', path: 'lobbies/lobby-easter-animated-2023.level', },
					{ name: 'Lobby easter 2023', path: 'lobbies/lobby-easter-2023.level', },
					{ name: 'Lobby forest (animated) 2023', path: 'lobbies/lobby-forest-animated-2023.level', },
					{ name: 'Lobby winter 2023', path: 'lobbies/lobby-winter-2023.level', },
					{ name: 'Lobby christmas (animated) 2022', path: 'lobbies/lobby-christmas-animated-2022.level', },
					{ name: 'Lobby christmas 2022', path: 'lobbies/lobby-christmas-2022.level', },
					{ name: 'Lobby restaurant 2022', path: 'lobbies/lobby-restaurant-2022.level', },
					{ name: 'Lobby halloween 2022', path: 'lobbies/lobby-halloween-2022.level', },
					{ name: 'Lobby dojo 2022', path: 'lobbies/lobby-dojo-2022.level', },
					{ name: 'Lobby beach 2022', path: 'lobbies/lobby-beach-2022.level', },
					{ name: 'Lobby temple 2022', path: 'lobbies/lobby-temple-2022.level', },
					{ name: 'Lobby cave 2022', path: 'lobbies/lobby-cave-2022.level', },
					{ name: 'Lobby treehouse 2022', path: 'lobbies/lobby-treehouse-2022.level', },
					{ name: 'Lobby christmas 2021', path: 'lobbies/lobby-christmas-2021.level', },
					{ name: 'Lobby by rad 2021', path: 'lobbies/lobby-original-2021.level', },
					{ name: "First 'lobby'", path: 'lobbies/first-lobby.level', },
				],
				Official: [
